...
report <- sprintf("Of 40 gene comparisons, %d have Bonferroni-adjusted p-values below 0.05. With valid input tests, this rule controls the probability of at least one false positive in the family at 5%%. Interpret the gene effect sizes alongside the adjusted evidence.",sum(adjusted<.05))
