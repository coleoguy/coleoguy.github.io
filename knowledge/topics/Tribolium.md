...
The red flour beetle (*Tribolium castaneum*) is a useful laboratory animal for understanding how genes control whether insects wander away from their home (a behavior called dispersal). Scientists bred beetles selectively for either high or low dispersal tendency to see how the trait would change. In just three generations, they saw huge differences: the starting population had 25% of beetles dispersing, but the high-dispersal line jumped to 59% while the low-dispersal line dropped to 5% ([Ruckman & Blackmon 2020, Finding 1](/knowledge/papers/10_1093_jhered_esaa030/#finding-1)). This fast change showed that dispersal genes were already present in the starting population and could be amplified quickly.
...
- Rapid but plateauing response to artificial selection on dispersal over five generations: [Ruckman & Blackmon 2020, Finding 1](/knowledge/papers/10_1093_jhered_esaa030/#finding-1)
- Simulation controls excluding allelic dispersion as an explanation for high inferred epistasis (empirical ratio 5.27 vs. simulated range 0–0.33): [Ruckman & Blackmon 2020, Finding 2](/knowledge/papers/10_1093_jhered_esaa030/#finding-2)
