...
- The most direct quantitative evidence for repeated origins in Acari comes from ancestral-state reconstruction on a broad mite phylogeny, yielding 7.9–12.9 independent transitions to haplodiploidy and only weak support for the reverse direction ([Blackmon et al. 2015, Finding 3](/knowledge/papers/10_1111_evo_12792/#finding-3)).
