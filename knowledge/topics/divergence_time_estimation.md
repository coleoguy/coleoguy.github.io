...
- [2020 ghost of a structured, Finding 1](/knowledge/papers/2020_ghost_of_a_structured/#finding-1): SNAPP overestimates divergence times between end-deme species by ~700% when T_D/N_D = 1 under low migration in a 10-deme linear stepping-stone model.
- [2020 ghost of a structured, Finding 2](/knowledge/papers/2020_ghost_of_a_structured/#finding-2): Overestimation becomes severe when the divergence-to-population-size ratio falls below 10 combined with low migration — a practical threshold for assessing bias risk.
