...
- **Model dependence of origin counts in Acari.** The estimated number of independent origins of haplodiploidy ranges from 7.9 (two-rate model) to 12.9 (one-rate model), with only limited support for the hypothesis that reversions from haplodiploidy back to diplodiploidy are possible. ([Blackmon et al. 2015, Finding 1](/knowledge/papers/10_1111_evo_12792/#finding-1))
