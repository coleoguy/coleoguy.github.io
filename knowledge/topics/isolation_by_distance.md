...
- [Hancock & Blackmon 2020, Finding 1](/knowledge/papers/2020_ghost_of_a_structured/#finding-1) — SNAPP overestimates end-deme divergence times by ~700% under low migration when TD/ND = 1 in a 10-deme linear stepping-stone model.
- [Hancock & Blackmon 2020, Finding 2](/knowledge/papers/2020_ghost_of_a_structured/#finding-2) — Severe bias threshold identified at TD/ND < 10 combined with low migration; provides an actionable screening criterion.
- [Hancock & Blackmon 2020, Finding 3](/knowledge/papers/2020_ghost_of_a_structured/#finding-3) — Ancestral Ne inflated ~7-fold (Ne ≈ 7,370 vs. Nc = 1,000) for end-deme species pairs under m = 0.001, while center-deme pairs show modest inflation (Ne ≈ 1,255).
