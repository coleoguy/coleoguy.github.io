...
- [2022 cave crawler, Finding 1](/knowledge/papers/2022_cave_crawler/#finding-1) — Of 1,140 genes with published FST values in *A. mexicanus*, only 83 had both FST outlier status and logFC measurements available from prior studies, quantifying the fragmented nature of population genomic data in this system.
...
- [CaveCrawler paper](/knowledge/papers/2022_cave_crawler/) — source of the primary finding on this page.