---
layout: default
title: "Chromosome number optima"
topic_slug: chromosome_number_optima
...
A practical complication is uneven taxonomic sampling. Within Coleoptera, family-level variance in chromosome number correlates positively with the number of records available for that family (r = 0.41), meaning that poorly sampled families contribute disproportionately little to estimates of modal counts and may harbor karyotypic diversity that would shift or broaden the apparent optima. [2024 drift beetles, Finding 1](/knowledge/papers/2024_drift_beetles/#finding-1)

## Supporting evidence

- **Adephaga bimodality and Polyphaga unimodality in beetles:** Autosome counts in Adephaga peak at both 11 and 18; in Polyphaga a single sharp peak at 9 accounts for nearly a third of all species. [2024 drift beetles, Finding 1](/knowledge/papers/2024_drift_beetles/#finding-1)
