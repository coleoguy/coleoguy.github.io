...
The five-cohort design demonstrated in the 2024 *Solanum* work ([Assessing the opportunity for 2024, Finding 1](/knowledge/papers/2024_solanum/#finding-1)) cannot estimate higher-order epistatic interactions, and its cytotype and maternal-effect terms are specific to interspecific crosses with cytonuclear complexity, limiting generalization to simpler intraspecific designs.
