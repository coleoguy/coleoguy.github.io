...
topic_slug: reproductive_isolation
last_updated: 2026-04-21T19:14:34.833822+00:00
...
- Studies applying similar hybrid-compatibility scoring methods to non-avian vertebrates (e.g., Cyprinid fishes, Bovidae) could test whether the domestication–compatibility association is order-specific.
- Alfieri et al. 2023 (cited within the source paper for genomic refutation of a guineafowl hybrid) would be worth incorporating to sharpen the evidence threshold for inter-family hybridization claims.
- Broader speciation-reversal literature (e.g., Grant & Grant on Darwin's finches) provides theoretical context for how managed environments relax prezygotic barriers.
