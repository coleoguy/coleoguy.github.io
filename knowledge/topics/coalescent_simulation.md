...
Quantitative simulation under a 10-deme linear stepping-stone model demonstrates that SNAPP overestimates divergence times between end-deme-derived species by approximately 700% when TD/ND = 1 and migration is low (m = 0.001). See [Hancock & Blackmon 2020, Finding 1](/knowledge/papers/10_1093_jhered_esaa042/#finding-1) for full details.
