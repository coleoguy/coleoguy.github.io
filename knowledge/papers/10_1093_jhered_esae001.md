...
> Notably, we find no correlation between the scaled variance- based estimates of karyotype evolution and the phyloge- netic model-based rate estimates for the nine clades with overlapping analyses (τ = 0.11, P-value = 0.76).
— p. 179
...
> In contrast, the credible interval for ΔR fission was en- tirely positive (0.005 to 0.044; Fig. 3A).
— p. 176
