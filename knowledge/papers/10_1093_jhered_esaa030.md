...
> For the empirical dataset, this value is 5.27. In contrast, for simulated datasets, the ratio ranged from zero to 0.33. This indicates that dispersion alone is unlikely to explain the large contribution of epistatic component that we infer from our empirical data.
— p. 503
