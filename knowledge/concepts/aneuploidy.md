...
primary_citation: "10_1002_bies_201500040#finding-3"
difficulty: intermediate
last_updated: 2026-04-23
permalink: /knowledge/concepts/aneuploidy/
---
<!-- tealc:card-start -->
# Aneuploidy
...
- [Fragile Y hypothesis](/knowledge/topics/fragile_y_hypothesis/) — aneuploidy rate is the key variable linking PAR loss to Y chromosome loss.
- [Sex chromosome evolution](/knowledge/topics/sex_chromosome_evolution/) — aneuploidy cost governs whether SA inversions can fix.

**Primary citation.**
> "TS occurs in ~3% of all conceptions, a high frequency for a mutation that acts effectively as a dominant lethal (TS causes 99% prenatal mortality)."
— [Blackmon & Demuth 2015, Finding 3](/knowledge/papers/10_1002_bies_201500040/#finding-3)

**Prerequisites:** none
**Next, learn about:** [pseudoautosomal region](/knowledge/concepts/par/), [achiasmy](/knowledge/concepts/achiasmy/)
<!-- tealc:card-end -->
...
- Aneuploidy is not polyploidy. Polyploidy adds one or more complete chromosome sets; aneuploidy adds or removes individual chromosomes. The two differ in gene dosage balance, fitness consequences, and evolutionary potential. Read about [polyploidy](/knowledge/concepts/polyploidy/) for the distinction.
...
Within the wiki, we suggest [polyploidy](/knowledge/concepts/polyploidy/) for the contrast between whole-set and single-chromosome copy-number change, [msci](/knowledge/concepts/msci/) for sex-chromosome-specific transcriptional silencing and its relation to segregation, and [sa-fusion](/knowledge/concepts/sa-fusion/) for how sexually antagonistic selection on fusions interacts with aneuploidy cost.
