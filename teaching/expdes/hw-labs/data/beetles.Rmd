...
(1) What	is	the	impact	of	having	a	larger	body, is	it	different	for	males	and	females?

The last two figures and the correlation tests answer this question quite clearly for females.  However, the picture in males is a little more complicated - you can consider both the way that body size impacts number of mating attempts and the number offspring that are produced by his daughters.

(2) What	are	the	best	predictors	for	number	of	mating	attempts	and	the	number	of	grandchildren	
that	a	male	will	produce?

These can be answered with correlation tests and scatter plots using the `plot` funciton.
