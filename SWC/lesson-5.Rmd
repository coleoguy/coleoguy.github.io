...
I largely follow <https://google.github.io/styleguide/Rguide.xml> the most important thing is to be consistant.
...
dat <- read.csv(file = "/Users/Karthik/files/dataset-2013-01.csv")
```
